...
class PassiveCrawl:
    ...
    def getIdealDomain(self, domainName):
        ...
        final_domain = final_domain.replace("continue=", "")
        final_domain = final_domain.replace("domain=", "")
        final_domain = final_domain.replace("forward=", "")
        final_domain = final_domain.replace("redir=", "")
        final_domain = final_domain.replace("redirect=", "")
        final_domain = final_domain.replace("redirect_to=", "")
        final_domain = final_domain.replace("redirect_uri=", "")
        final_domain = final_domain.replace("reference=", "")
        final_domain = final_domain.replace("return=", "")
        final_domain = final_domain.replace("returnTo=", "")
        final_domain = final_domain.replace("return_path=", "")
        final_domain = final_domain.replace("return_to=", "")
        final_domain = final_domain.replace("return_url=", "")
        final_domain = final_domain.replace("rurl=", "")
        final_domain = final_domain.replace("show=", "")
        final_domain = final_domain.replace("site=", "")
        final_domain = final_domain.replace("target=", "")
        final_domain = final_domain.replace("uri=", "")
        final_domain = final_domain.replace("url=", "")
        final_domain = final_domain.replace("val=", "")
        final_domain = final_domain.replace("window=" "")
        final_domain = final_domain.replace("callback=", "")
        final_domain = final_domain.replace("Open=", "")
